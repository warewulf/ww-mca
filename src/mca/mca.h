 ...
 * @file
 *
 * Top-level interface for all Warewulf MCA components.
 */
 ...
 *
 * @retval WW_SUCCESS This component can be used in the process.
 *
 * @retval WW_ERR_NOT_AVAILABLE Silently ignore this component for
 ...
 *
 * This function should return WW_SUCCESS if it wishes to remain
 ...
 * function and it returned WW_SUCCESS.
 */
 ...
 *
 * @retval WW_SUCCESS The component successfully shut down.
 *
 ...
 * close function and it returned WW_SUCCESS.
 */
 ...
 *
 * @retval WW_SUCCESS The component successfully queried.
 *
 * @retval any_other_value Some error occurred, but is likely to be
 * ignored.
 *
 ...
 *
 * @retval WW_SUCCESS This component successfully registered its
 * parameters and can be used in this process.
 * @retval WW_ERR_BAD_PARAM Indicates that the register function
 ...
 * mechanism is available should the need arise.
 *
 * Note that if the function returns WW_ERR_BAD_PARAM, it is
 ...
 * registration function and it returned WW_SUCCESS.
 */
...
#define WW_MCA_BASE_VERSION_1_0_0(type, type_major, type_minor, type_release) \
    MCA_BASE_VERSION_2_1_0("Warewulf", WW_MAJOR_VERSION, WW_MINOR_VERSION,      \
                           WW_RELEASE_VERSION, type, type_major, type_minor,  \
                           type_release)
