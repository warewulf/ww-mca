 ...
 * Globals
 */
ww_dl_base_module_t *ww_dl = NULL;
ww_dl_base_component_t *ww_dl_base_selected_component = NULL;
 ...
 */
int ww_dl_base_open(mca_base_open_flag_t flags)
{
    /* Open up all available components */
    return mca_base_framework_components_open(&ww_dl_base_framework, flags);
}
...
/* VERY IMPORTANT: This framework is static, and is opened before any
   ...
   framework. */
MCA_BASE_FRAMEWORK_DECLARE(ww, dl, "Dynamic loader framework",
                           NULL /* register */,
                           ww_dl_base_open /* open */,
                           NULL /* close */,
