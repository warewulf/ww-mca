...
#ifndef WW_MCA_DL_DL_H
#define WW_MCA_DL_DL_H
...
typedef struct ww_dl_handle_t ww_dl_handle_t;
 ...
 * freed during the call to ww_dl_base_module_dlclose_fn_t).
 *
 ...
 * change after successive calls to ww_dl API calls.
 */
typedef int (*ww_dl_base_module_open_fn_t)
 ...
 * change after successive calls to ww_dl API calls.
 */
typedef int (*ww_dl_base_module_lookup_fn_t)
    (ww_dl_handle_t *handle, const char *symbol, void **ptr, char **err_msg);
 ...
 */
typedef int (*ww_dl_base_module_close_fn_t)
    (ww_dl_handle_t *handle);
 ...
 */
typedef int (*ww_dl_base_module_foreachfile_fn_t)
 ...
 */
struct ww_dl_base_component_1_0_0_t {
    /** MCA base component */
...
typedef struct ww_dl_base_component_1_0_0_t ww_dl_base_component_1_0_0_t;
typedef struct ww_dl_base_component_1_0_0_t ww_dl_base_component_t;

/**
 * Structure for DL modules
 */
struct ww_dl_base_module_1_0_0_t {
    mca_base_module_2_0_0_t                 super;

    /** Open / close */
    ww_dl_base_module_open_fn_t           open;
    ww_dl_base_module_close_fn_t          close;

    /** Lookup a symbol */
    ww_dl_base_module_lookup_fn_t         lookup;

    /** Iterate looking for files */
    ww_dl_base_module_foreachfile_fn_t    foreachfile;
};
typedef struct ww_dl_base_module_1_0_0_t ww_dl_base_module_1_0_0_t;
typedef struct ww_dl_base_module_1_0_0_t ww_dl_base_module_t;

/**
 * Macro for use in components that are of type DL
 */
#define WW_DL_BASE_VERSION_1_0_0              \
    WW_MCA_BASE_VERSION_1_0_0("dl", 1, 0, 0)

END_C_DECLS

#endif /* WW_MCA_DL_DL_H */
