...
static int register_components(mca_base_framework_t *framework)
{
    ...
    WW_LIST_FOREACH_SAFE(cli, next, &framework->framework_components, mca_base_component_list_item_t) {
        ...
        if (WW_SUCCESS != ret) {
            if (WW_ERR_NOT_AVAILABLE != ret) {
                /* If the component returns WW_ERR_NOT_AVAILABLE,
                ...
                if (mca_base_component_show_load_errors) {
                    ww_output_verbose (MCA_BASE_VERBOSE_ERROR, output_id,
            ...
            ww_list_remove_item (&framework->framework_components, &cli->super);
        ...
        if (NULL != component->mca_register_component_params) {
            ww_output_verbose (MCA_BASE_VERBOSE_COMPONENT, output_id, "mca: base: components_register: "
        ...
        mca_base_component_var_register (component, "major_version", NULL, MCA_BASE_VAR_TYPE_INT, NULL,
                                         ...
                                         WW_INFO_LVL_9, MCA_BASE_VAR_SCOPE_CONSTANT,
