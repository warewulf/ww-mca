...
#ifndef WW_MCA_BASE_VAR_GROUP_H
#define WW_MCA_BASE_VAR_GROUP_H
...
struct mca_base_var_group_t {
    ...
    ww_value_array_t group_subgroups;

    /** Integer array of group variables */
    ww_value_array_t group_vars;
 ...
 */
WW_DECLSPEC WW_CLASS_DECLARATION(mca_base_var_group_t);
 ...
 */
WW_DECLSPEC int mca_base_var_group_register(const char *project_name,
 ...
 * @return Warewulf error code on Error
 */
WW_DECLSPEC int mca_base_var_group_component_register (const mca_base_component_t *component,
                                                         const char *description);
 ...
 */
WW_DECLSPEC int mca_base_var_group_deregister (int group_index);
 ...
 *
 * @returns WW_SUCCESS if found
 * @returns WW_ERR_NOT_FOUND if not found
 */
WW_DECLSPEC int mca_base_var_group_find (const char *project_name,
                                           const char *framework_name,
                                           const char *component_name);
 ...
 * @returns WW_ERR_NOT_FOUND if not found
 */
WW_DECLSPEC int mca_base_var_group_find_by_name (const char *full_name, int *index);
 ...
 *
 * @retval WW_ERR_NOT_FOUND If the group specified by group_index does not exist.
 * @retval WW_SUCCESS If the group is found
 *
 * The returned pointer belongs to the MCA variable system. Do not modify/release/retain
 * the pointer.
 */
WW_DECLSPEC int mca_base_var_group_get (const int group_index,
 ...
 */
WW_DECLSPEC int mca_base_var_group_set_var_flag (const int group_index, int flags,
                                                   bool set);
 ...
 */
WW_DECLSPEC int mca_base_var_group_get_count (void);
 ...
 */
WW_DECLSPEC int mca_base_var_group_get_stamp (void);

#endif /* WW_MCA_BASE_VAR_GROUP_H */
