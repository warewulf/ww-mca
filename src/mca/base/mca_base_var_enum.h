 ...
 *
 * @retval WW_SUCCESS if found
 * @retval WW_ERR_VALUE_OUT_OF_BOUNDS if not
 */
 ...
 * @retval Warewulf error on error
 */
 ...
 *
 * @retval WW_SUCCESS on success
 * @retval WW_ERR_VALUE_OUT_OF_BOUNDS if not found
 *
...
struct mca_base_var_enum_t {
    ...
    /** Given a string return corresponding integer value. If the string does not match a
     valid value return WW_ERR_VALUE_OUT_OF_BOUNDS */
    ...
    /** Given an integer return the corresponding string value. If the integer does not
        match a valid value return WW_ERR_VALUE_OUT_OF_BOUNDS */
 ...
 */
WW_DECLSPEC WW_CLASS_DECLARATION(mca_base_var_enum_t);
 ...
 *
 * @retval WW_SUCCESS On success
 * @retval Warewulf error code On error
 *
 ...
 * returns.
 */
WW_DECLSPEC int mca_base_var_enum_create (const char *name, const mca_base_var_enum_value_t values[],
 ...
 * returns.
 */
WW_DECLSPEC int mca_base_var_enum_create_flag (const char *name, const mca_base_var_enum_value_flag_t flags[],
