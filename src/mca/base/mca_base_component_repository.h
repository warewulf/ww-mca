 ...
 * internal to the Warewulf/mca/base).  But it's convenient to have all
...
WW_CLASS_DECLARATION(mca_base_component_repository_item_t);
 ...
 */
WW_DECLSPEC int mca_base_component_repository_init(void);
 ...
 */
WW_DECLSPEC int mca_base_component_repository_add (const char *path);
 ...
 */
WW_DECLSPEC int mca_base_component_repository_get_components (mca_base_framework_t *framework,
                                                                ww_list_t **framework_components);

/**
 * @brief finalize the mca component repository
 */
WW_DECLSPEC void mca_base_component_repository_finalize(void);
