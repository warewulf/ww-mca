...
#if !defined(WW_MCA_BASE_FRAMEWORK_H)
#define WW_MCA_BASE_FRAMEWORK_H
 ...
 * @retval Warewulf error code on failure
 *
 ...
 *
 * This function is invoked during ww_init() and during the
 ...
 * framework, and is called during ww_finalize() and the
...
typedef struct mca_base_framework_t {
    /** Project name for this component (ex "Warewulf") */
 ...
 */
WW_DECLSPEC int mca_base_framework_register (mca_base_framework_t *framework,
 ...
 */
WW_DECLSPEC int mca_base_framework_open (mca_base_framework_t *framework,
 ...
 */
WW_DECLSPEC int mca_base_framework_close (mca_base_framework_t *framework);
 ...
 * @retval false if not
 */
WW_DECLSPEC bool mca_base_framework_is_registered (struct mca_base_framework_t *framework);
 ...
 * @retval false if not
 */
WW_DECLSPEC bool mca_base_framework_is_open (struct mca_base_framework_t *framework);
 ...
 *
 * Example:
 *  MCA_BASE_FRAMEWORK_DECLARE(Warewulf, foo, NULL, ww_foo_open, ww_foo_close, MCA_BASE_FRAMEWORK_FLAG_LAZY)
 */
