...
# --------------------------------------------------------------------
AC_DEFUN([MCA_ww_sec_munge_CONFIG],[
    AC_CONFIG_FILES([src/mca/sec/munge/Makefile])

    WW_VAR_SCOPE_PUSH([sec_munge_support sec_munge_dir sec_munge_libdir save_cpp save_ld])
