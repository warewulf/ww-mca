 ...
 */
WW_DECLSPEC char *ww_path_find(char *fname, char **pathv, int mode,
                                   char **envv) __ww_attribute_malloc__ __ww_attribute_warn_unused_result__;
 ...
 * The caller is responsible for freeing the returned string.
 */
WW_DECLSPEC char *ww_path_findv(char *fname, int mode,
                                    char **envv, char *wrkdir) __ww_attribute_malloc__ __ww_attribute_warn_unused_result__;
/**
 ...
 */
WW_DECLSPEC bool ww_path_is_absolute( const char *path );
 ...
 * will be returned.
 */
WW_DECLSPEC char* ww_find_absolute_path( char* app_name ) __ww_attribute_warn_unused_result__;
 ...
 * The caller is responsible for freeing the returned string.
 */
WW_DECLSPEC char *ww_path_access(char *fname, char *path, int mode) __ww_attribute_malloc__ __ww_attribute_warn_unused_result__;
 ...
 * @retval false               otherwise
 */
WW_DECLSPEC bool ww_path_nfs(char *fname, char **fstype) __ww_attribute_warn_unused_result__;
 ...
 *
 * @retval WW_SUCCESS  If the operation was successful
 * @retval WW_ERROR    otherwise
 */
WW_DECLSPEC int
ww_path_df(const char *path,
             uint64_t *out_avail)__ww_attribute_warn_unused_result__;
