 ...
 *
 * The ww_os_path() function takes a variable number of string arguments and
...
*/
WW_DECLSPEC char *ww_os_path(bool relative, ...) __ww_attribute_malloc__ __ww_attribute_sentinel__ __ww_attribute_warn_unused_result__;

/**
 * Convert the path to be OS friendly. On UNIX this function will
 * be empty.
 */
#define ww_make_filename_os_friendly(PATH)   (PATH)
