 ...
 */
WW_DECLSPEC int  ww_snprintf(char *str, size_t size, const char *fmt, ...) __ww_attribute_format__(__printf__, 3, 4);
 ...
 */
WW_DECLSPEC int  ww_vsnprintf(char *str, size_t size, const char *fmt, va_list ap) __ww_attribute_format__(__printf__, 3, 0);
 ...
 */
WW_DECLSPEC int  ww_asprintf(char **ptr, const char *fmt, ...) __ww_attribute_format__(__printf__, 2, 3);
 ...
 */
WW_DECLSPEC int  ww_vasprintf(char **ptr, const char *fmt, va_list ap) __ww_attribute_format__(__printf__, 2, 0);
