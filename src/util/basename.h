...
#ifndef WW_BASENAME_H
#define WW_BASENAME_H
 ...
 */
WW_DECLSPEC char *ww_basename(const char* filename) __ww_attribute_malloc__ __ww_attribute_warn_unused_result__;
 ...
 * The caller is responsible for freeing the returned string.
 */
WW_DECLSPEC char *ww_dirname(const char* filename) __ww_attribute_malloc__ __ww_attribute_warn_unused_result__;
