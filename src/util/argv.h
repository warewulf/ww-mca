...
BEGIN_C_DECLS
   ...
   */
WW_DECLSPEC  ww_status_t ww_argv_append(int *argc, char ***argv, const char *arg) __ww_attribute_nonnull__(1) __ww_attribute_nonnull__(3);
   ...
   * @retval WW_ERROR On failure
   *
   * This function is identical to the ww_argv_append() function
   ...
   */
WW_DECLSPEC  ww_status_t ww_argv_append_nosize(char ***argv, const char *arg);
 ...
 * @retval WW_ERROR On failure
 */
WW_DECLSPEC ww_status_t ww_argv_prepend_nosize(char ***argv, const char *arg);
 ...
 * @retval WW_ERROR On failure
 *
 * This function is identical to the ww_argv_append_nosize() function
 ...
 */
WW_DECLSPEC  ww_status_t ww_argv_append_unique_nosize(char ***argv, const char *arg, bool overwrite);
...
/**
   ...
   * array.
   */
WW_DECLSPEC  void ww_argv_free(char **argv);
   ...
   */
WW_DECLSPEC  char **ww_argv_split(const char *src_string, int delimiter) __ww_attribute_malloc__ __ww_attribute_warn_unused_result__;
   ...
   * without invalidating the output argv).
   */
WW_DECLSPEC  char **ww_argv_split_with_empty(const char *src_string, int delimiter) __ww_attribute_malloc__ __ww_attribute_warn_unused_result__;
   ...
   */
WW_DECLSPEC  int ww_argv_count(char **argv);
   ...
   */
WW_DECLSPEC  char *ww_argv_join(char **argv, int delimiter) __ww_attribute_malloc__ __ww_attribute_warn_unused_result__;

WW_DECLSPEC  char *ww_argv_join_range(char **argv, size_t start, size_t end, int delimiter) __ww_attribute_malloc__ __ww_attribute_warn_unused_result__;
   ...
   */
WW_DECLSPEC  size_t ww_argv_len(char **argv);
   ...
   */
WW_DECLSPEC  char **ww_argv_copy(char **argv) __ww_attribute_malloc__ __ww_attribute_warn_unused_result__;
     ...
     */
WW_DECLSPEC  ww_status_t ww_argv_delete(int *argc, char ***argv,
     ...
     * @retval WW_BAD_PARAM if any parameters are non-sensical
     *
     ...
     * Similar to ww_argv_append(), the target may be realloc()'ed
     ...
     * target).
     */
WW_DECLSPEC  ww_status_t ww_argv_insert(char ***target, int start, char **source);
 ...
 * target).
 */
WW_DECLSPEC  ww_status_t ww_argv_insert_element(char ***target, int location, char *source);
