 ...
 *
 * The function ww_show_help() is used to find a help message and
 ...
 * ww_show_help() takes a variable legnth argument list that are
 ...
 * and therefore the component can invoke ww_show_help() to display
...
#ifndef WW_SHOW_HELP_H
#define WW_SHOW_HELP_H
 ...
 */
WW_DECLSPEC int ww_show_help_init(void);
 ...
 */
WW_DECLSPEC int ww_show_help_finalize(void);
 ...
 */
typedef int (*ww_show_help_fn_t)(const char *filename, const char *topic,
                                   bool want_error_header, ...);
WW_DECLSPEC extern ww_show_help_fn_t ww_show_help;

/**
 * This function does the same thing as ww_show_help(), but accepts
 * a va_list form of varargs.
 */
typedef int (*ww_show_vhelp_fn_t)(const char *filename, const char *topic,
                                    bool want_error_header, va_list ap);
WW_DECLSPEC extern ww_show_vhelp_fn_t ww_show_vhelp;

/**
 * This function does the same thing as ww_show_help(), but returns
 * its output in a string (that must be freed by the caller).
 */
WW_DECLSPEC char* ww_show_help_string(const char *filename,
                                          const char *topic,
                                          bool want_error_header, ...);

/**
 * This function does the same thing as ww_show_help_string(), but
 * accepts a va_list form of varargs.
 */
WW_DECLSPEC char* ww_show_help_vstring(const char *filename,
                                          const char *topic,
                                          bool want_error_header, va_list ap);
 ...
 */
WW_DECLSPEC int ww_show_help_add_dir(const char *directory);
