...
#if !defined(WW_SYS_ARCH_ATOMIC_H)
...
#define WW_ASM_MAKE_ATOMIC(type, bits, name, inst, reg)                   \
    static inline type ww_atomic_ ## name ## _ ## bits (volatile type *addr, type value) \
    {                                                                   \
        type newval;                                                    \
        int32_t tmp;                                                    \
                                                                        \
...
WW_ASM_MAKE_ATOMIC(int32_t, 32, add, "add", "w")
WW_ASM_MAKE_ATOMIC(int32_t, 32, sub, "sub", "w")
WW_ASM_MAKE_ATOMIC(int64_t, 64, add, "add", "")
WW_ASM_MAKE_ATOMIC(int64_t, 64, sub, "sub", "")
