...
#define WW_HAVE_ATOMIC_LLSC_32 1
...
#if (WW_ASSEMBLY_ARCH == WW_POWERPC64) || WW_ASM_SUPPORT_64BIT
#define WW_HAVE_ATOMIC_CMPSET_64 1
#define WW_HAVE_ATOMIC_SWAP_64 1
#define WW_HAVE_ATOMIC_LLSC_64 1
#endif
...
#elif WW_XLC_INLINE_ASSEMBLY /* end WW_GCC_INLINE_ASSEMBLY */
...
#undef WW_HAVE_INLINE_ATOMIC_MEM_BARRIER
#define WW_HAVE_INLINE_ATOMIC_MEM_BARRIER 0

#pragma mc_func ww_atomic_mb { "7c0004ac" }          /* sync  */
#pragma reg_killed_by ww_atomic_mb                   /* none */

#pragma mc_func ww_atomic_rmb { "7c2004ac" }         /* lwsync  */
#pragma reg_killed_by ww_atomic_rmb                  /* none */

#pragma mc_func ww_atomic_wmb { "7c0006ac" }         /* eieio */
#pragma reg_killed_by ww_atomic_wmb                  /* none */
...
#define WW_ASM_ADDR(a) ((uintptr_t)a)
#else
#define WW_ASM_ADDR(a) (a)
#endif
                                        ...
                                        int32_t oldval, int32_t newval)
{
   ...
   __asm__ __volatile__ (
                         ...
                         "2:"
                         : "=&r" (ret), "=m" (*addr)
                         : "r" WW_ASM_ADDR(addr), "r" (oldval), "r" (newval), "m" (*addr)
                         : "cc", "memory");

   return (ret == oldval);
}

static inline int32_t ww_atomic_ll_32 (volatile int32_t *addr)
{
   int32_t ret;
...
static inline int ww_atomic_sc_32 (volatile int32_t *addr, int32_t newval)
{
    int32_t ret, foo;
...
#if (WW_ASSEMBLY_ARCH == WW_POWERPC64)
...
static inline int64_t ww_atomic_ll_64(volatile int64_t *addr)
{
   int64_t ret;
...
static inline int ww_atomic_sc_64(volatile int64_t *addr, int64_t newval)
{
    int32_t ret, foo;
...
#elif (WW_ASSEMBLY_ARCH == WW_POWERPC32) && WW_ASM_SUPPORT_64BIT
...
#endif /* WW_ASM_SUPPORT_64BIT */


#if WW_GCC_INLINE_ASSEMBLY

static inline int32_t ww_atomic_add_32(volatile int32_t* v, int inc)
{
   int32_t t;
...
static inline int32_t ww_atomic_sub_32(volatile int32_t* v, int dec)
{
   int32_t t;
