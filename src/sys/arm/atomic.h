...
#if (WW_HAVE_ATOMIC_MEM_BARRIER == 1)
...
#if (WW_GCC_INLINE_ASSEMBLY && (WW_ASM_ARM_VERSION >= 6))
...
#else /* WW_ASM_ARM_VERSION <=5 or no GCC inline assembly */
