 ...
 * @file
 *
 * Implementation of ww_object_t, the base ww foundation class
 */
...
ww_class_t ww_object_t_class = {
    ...
    sizeof(ww_object_t) /* size of the ww object */
};
 ...
 * Local functions
 */
static void save_class(ww_class_t *cls);
 ...
 */
void ww_class_initialize(ww_class_t *cls)
{
    ww_class_t *c;
    ...
    cls->cls_construct_array =
        (void (**)(ww_object_t*))malloc((cls_construct_array_count +
                                           cls_destruct_array_count + 2) *
                                          sizeof(ww_construct_t) );
