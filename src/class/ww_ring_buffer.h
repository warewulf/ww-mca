...
#ifndef WW_RING_BUFFER_H
#define WW_RING_BUFFER_H
 ...
 * Convenience typedef
 */
typedef struct ww_ring_buffer_t ww_ring_buffer_t;
/**
 * Class declaration
 */
WW_DECLSPEC WW_CLASS_DECLARATION(ww_ring_buffer_t);
 ...
 */
WW_DECLSPEC int ww_ring_buffer_init(ww_ring_buffer_t* ring, int size);
 ...
 *         is not yet full
 */
WW_DECLSPEC void* ww_ring_buffer_push(ww_ring_buffer_t *ring, void *ptr);
...
WW_DECLSPEC void* ww_ring_buffer_pop(ww_ring_buffer_t *ring);
 ...
 */
WW_DECLSPEC void* ww_ring_buffer_poke(ww_ring_buffer_t *ring, int i);

END_C_DECLS

#endif /* WW_RING_BUFFER_H */
