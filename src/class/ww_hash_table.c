...
typedef struct ww_hash_element_t ww_hash_element_t;

struct ww_hash_type_methods_t {
    /* Frees any storage associated with the element
     * The value is not owned by the hash table
     * The key,key_size of pointer keys is
     */
    void        (*elt_destructor)(ww_hash_element_t * elt);
    /* Hash the key of the element -- for growing and adjusting-after-removal */
    uint64_t    (*hash_elt)(ww_hash_element_t * elt);
};

/* interact with the class-like mechanism */

static void ww_hash_table_construct(ww_hash_table_t* ht);
static void ww_hash_table_destruct(ww_hash_table_t* ht);

WW_CLASS_INSTANCE(
    ww_hash_table_t,
    ww_object_t,
    ww_hash_table_construct,
    ww_hash_table_destruct
);

static void
ww_hash_table_construct(ww_hash_table_t* ht)
{
  ht->ht_table = NULL;
...
static void
ww_hash_table_destruct(ww_hash_table_t* ht)
{
...
static size_t
ww_hash_round_capacity_up(size_t capacity)
{
...
int                             /* WW_ return code */
ww_hash_table_init2(ww_hash_table_t* ht, size_t estimated_max_size,
                      ...
                      int growth_numer, int growth_denom)
{
    ...
    size_t capacity = ww_hash_round_capacity_up(est_capacity);
    ht->ht_table = (ww_hash_element_t*) calloc(capacity, sizeof(ww_hash_element_t));
    if (NULL == ht->ht_table) {
...
int                             /* WW_ return code */
ww_hash_table_init(ww_hash_table_t* ht, size_t table_size)
{
    /* default to density of 1/2 and growth of 2/1 */
    return ww_hash_table_init2(ht, table_size, 1, 2, 2, 1);
}

int                             /* WW_ return code */
ww_hash_table_remove_all(ww_hash_table_t* ht)
{
    size_t ii;
    for (ii = 0; ii < ht->ht_capacity; ii += 1) {
        ww_hash_element_t * elt = &ht->ht_table[ii];
...
static int                      /* WW_ return code */
ww_hash_grow(ww_hash_table_t * ht)
{
    size_t jj, ii;
    ww_hash_element_t* old_table;
    ww_hash_element_t* new_table;
    size_t old_capacity;
    size_t new_capacity;
    ...
    new_capacity = ww_hash_round_capacity_up(new_capacity);

    new_table    = (ww_hash_element_t*) calloc(new_capacity, sizeof(new_table[0]));
    if (NULL == new_table) {
        return WW_ERR_OUT_OF_RESOURCE;
    }
    ...
    for (jj = 0; jj < old_capacity; jj += 1) {
        ww_hash_element_t * old_elt;
        ww_hash_element_t * new_elt;
...
static int                      /* WW_ return code */
ww_hash_table_remove_elt_at(ww_hash_table_t * ht, size_t ii)
{
    size_t jj, capacity = ht->ht_capacity;
    ww_hash_element_t* elts = ht->ht_table;
    ww_hash_element_t * elt;
...
static uint64_t
ww_hash_hash_elt_uint32(ww_hash_element_t * elt)
{
  return elt->key.u32;
}

static const struct ww_hash_type_methods_t
ww_hash_type_methods_uint32 = {
    NULL,
    ww_hash_hash_elt_uint32
};

int                             /* WW_ return code */
ww_hash_table_get_value_uint32(ww_hash_table_t* ht, uint32_t key, void * *value)
{
...
#if WW_ENABLE_DEBUG
    if(capacity == 0) {
        ww_output(0, "ww_hash_table_get_value_uint32:"
                    "ww_hash_table_init() has not been called");
        return WW_ERROR;
    }
    if (NULL != ht->ht_type_methods &&
        &ww_hash_type_methods_uint32 != ht->ht_type_methods) {
        ww_output(0, "ww_hash_table_get_value_uint32:"
    ...
    ht->ht_type_methods = &ww_hash_type_methods_uint32;
...
int                             /* WW_ return code */
ww_hash_table_set_value_uint32(ww_hash_table_t * ht, uint32_t key, void * value)
{
    int rc;
    size_t ii, capacity = ht->ht_capacity;
    ww_hash_element_t * elt;
...
#if WW_ENABLE_DEBUG
    if(capacity == 0) {
        ww_output(0, "ww_hash_table_set_value_uint32:"
                   "ww_hash_table_init() has not been called");
    ...
    for (ii = key%capacity; ; ii += 1) {
        ...
        if (! elt->valid) {
            ...
            if (ht->ht_size >= ht->ht_growth_trigger) {
                if (WW_SUCCESS != (rc = ww_hash_grow(ht))) {
                    return rc;
                }
            }
            return WW_SUCCESS;
...
int
ww_hash_table_remove_value_uint32(ww_hash_table_t * ht, uint32_t key)
{
    size_t ii, capacity = ht->ht_capacity;
    ...
    if (NULL != ht->ht_type_methods &&
        &ww_hash_type_methods_uint32 != ht->ht_type_methods) {
        ww_output(0, "ww_hash_table_remove_value_uint32:"
                    "hash table is for a different key type");
            return WW_ERROR;
    }
#endif
    ...
    for (ii = key%capacity; ; ii += 1) {
        ...
        if (! elt->valid) {
            ...
            return ww_hash_table_remove_elt_at(ht, ii);
        } else {
            /* keep looking */
        }
    }
...
static uint64_t
ww_hash_hash_elt_uint64(ww_hash_element_t * elt)
{
  return elt->key.u64;
}

static const struct ww_hash_type_methods_t
ww_hash_type_methods_uint64 = {
    NULL,
    ww_hash_hash_elt_uint64
};

int                             /* WW_ return code */
ww_hash_table_get_value_uint64(ww_hash_table_t * ht, uint64_t key, void * *value)
{
    size_t ii;
...
#if WW_ENABLE_DEBUG
    if(capacity == 0) {
        ww_output(0, "ww_hash_table_get_value_uint64:"
                   "ww_hash_table_init() has not been called");
        return WW_ERROR;
    }
    if (NULL != ht->ht_type_methods &&
        &ww_hash_type_methods_uint64 != ht->ht_type_methods) {
        ww_output(0, "ww_hash_table_get_value_uint64:"
                    "hash table is for a different key type");
            return WW_ERROR;
    }
    ...
    ht->ht_type_methods = &ww_hash_type_methods_uint64;
    for (ii = key%capacity; ; ii += 1) {
        if (ii == capacity) { ii = 0; }
        elt = &ht->ht_table[ii];
        if (! elt->valid) {
...
int                             /* WW_ return code */
ww_hash_table_set_value_uint64(ww_hash_table_t * ht, uint64_t key, void * value)
{
    int rc;
    size_t ii, capacity = ht->ht_capacity;
    ww_hash_element_t * elt;
...
#if WW_ENABLE_DEBUG
    if(capacity == 0) {
        ww_output(0, "ww_hash_table_set_value_uint64:"
                   "ww_hash_table_init() has not been called");
        return WW_ERR_BAD_PARAM;
    }
    if (NULL != ht->ht_type_methods &&
...
int                             /* WW_ return code */
ww_hash_table_remove_value_uint64(ww_hash_table_t * ht, uint64_t key)
{
    size_t ii, capacity = ht->ht_capacity;
    ...
    if (NULL != ht->ht_type_methods &&
        &ww_hash_type_methods_uint64 != ht->ht_type_methods) {
        ww_output(0, "ww_hash_table_remove_value_uint64:"
                    "hash table is for a different key type");
            return WW_ERROR;
    }
#endif
...
static uint64_t
ww_hash_hash_key_ptr(const void * key, size_t key_size)
{
    uint64_t hash;
...
static void
ww_hash_destruct_elt_ptr(ww_hash_element_t * elt)
{
...
static uint64_t
ww_hash_hash_elt_ptr(ww_hash_element_t * elt)
{
    return ww_hash_hash_key_ptr(elt->key.ptr.key, elt->key.ptr.key_size);
}

static const struct ww_hash_type_methods_t
ww_hash_type_methods_ptr = {
    ww_hash_destruct_elt_ptr,
    ww_hash_hash_elt_ptr
};

int                             /* WW_ return code */
ww_hash_table_get_value_ptr(ww_hash_table_t * ht,
                              ...
                              void * *value)
{
...
#if WW_ENABLE_DEBUG
    if(capacity == 0) {
        ww_output(0, "ww_hash_table_get_value_ptr:"
                   "ww_hash_table_init() has not been called");
        return WW_ERROR;
    }
    if (NULL != ht->ht_type_methods &&
        &ww_hash_type_methods_ptr != ht->ht_type_methods) {
        ww_output(0, "ww_hash_table_get_value_ptr:"
                    "hash table is for a different key type");
            return WW_ERROR;
    }
    ...
    ht->ht_type_methods = &ww_hash_type_methods_ptr;
    for (ii = ww_hash_hash_key_ptr(key, key_size)%capacity; ; ii += 1) {
        if (ii == capacity) { ii = 0; }
        elt = &ht->ht_table[ii];
        if (! elt->valid) {
            return WW_ERR_NOT_FOUND;
...
int                             /* WW_ return code */
ww_hash_table_set_value_ptr(ww_hash_table_t * ht,
                              const void * key, size_t key_size,
                              void * value)
{
    int rc;
...
#if WW_ENABLE_DEBUG
    if(capacity == 0) {
        ww_output(0, "ww_hash_table_set_value_ptr:"
                   "ww_hash_table_init() has not been called");
        return WW_ERR_BAD_PARAM;
    }
    if (NULL != ht->ht_type_methods &&
...
int                             /* WW_ return code */
ww_hash_table_remove_value_ptr(ww_hash_table_t * ht,
                                 const void * key, size_t key_size)
{
    size_t ii, capacity = ht->ht_capacity;
    ...
    if (NULL != ht->ht_type_methods &&
        &ww_hash_type_methods_ptr != ht->ht_type_methods) {
        ww_output(0, "ww_hash_table_remove_value_ptr:"
                    "hash table is for a different key type");
            return WW_ERROR;
    }
#endif
...
static int                      /* WW_ return code */
ww_hash_table_get_next_elt(ww_hash_table_t *ht,
                             ww_hash_element_t * prev_elt, /* NULL means find first */
                             ww_hash_element_t * *next_elt)
{
  ww_hash_element_t* elts = ht->ht_table;
  size_t ii, capacity = ht->ht_capacity;

  for (ii = (NULL == prev_elt ? 0 : (prev_elt-elts)+1); ii < capacity; ii += 1) {
    ww_hash_element_t * elt = &elts[ii];
    if (elt->valid) {
      *next_elt = elt;
      return WW_SUCCESS;
    }
...
int                             /* WW_ return code */
ww_hash_table_get_first_key_uint32(ww_hash_table_t * ht,
                                     uint32_t *key, void * *value,
                                     void * *node)
{
  return ww_hash_table_get_next_key_uint32(ht, key, value, NULL, node);
}

int                             /* WW_ return code */
ww_hash_table_get_next_key_uint32(ww_hash_table_t * ht,
                                    uint32_t *key, void * *value,
                                    void * in_node, void * *out_node)
{
  ww_hash_element_t * elt;
  if (WW_SUCCESS == ww_hash_table_get_next_elt(ht, (ww_hash_element_t *) in_node, &elt)) {
    *key       = elt->key.u32;
    *value     = elt->value;
    *out_node  = elt;
    return WW_SUCCESS;
...
int                             /* WW_ return code */
ww_hash_table_get_first_key_ptr(ww_hash_table_t * ht,
                                  void * *key, size_t *key_size, void * *value,
                                  void * *node)
{
  return ww_hash_table_get_next_key_ptr(ht, key, key_size, value, NULL, node);
}

int                             /* WW_ return code */
ww_hash_table_get_next_key_ptr(ww_hash_table_t * ht,
                                 void * *key, size_t *key_size, void * *value,
                                 void * in_node, void * *out_node)
{
  ww_hash_element_t * elt;
...
int                             /* WW_ return code */
ww_hash_table_get_first_key_uint64(ww_hash_table_t * ht,
                                     uint64_t *key, void * *value,
                                     void * *node)
{
  return ww_hash_table_get_next_key_uint64(ht, key, value, NULL, node);
}

int                             /* WW_ return code */
ww_hash_table_get_next_key_uint64(ww_hash_table_t * ht,
                                    uint64_t *key, void * *value,
                                    void * in_node, void * *out_node)
{
  ww_hash_element_t * elt;
