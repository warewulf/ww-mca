...
#ifndef WW_POINTER_ARRAY_H
#define WW_POINTER_ARRAY_H
 ...
 * Convenience typedef
 */
typedef struct ww_pointer_array_t ww_pointer_array_t;
/**
 * Class declaration
 */
WW_DECLSPEC WW_CLASS_DECLARATION(ww_pointer_array_t);
 ...
 *
 * @return WW_SUCCESS if all initializations were succesfull. Otherwise,
 *  the error indicate what went wrong in the function.
 */
WW_DECLSPEC ww_status_t ww_pointer_array_init(ww_pointer_array_t* array,
 ...
 */
WW_DECLSPEC int ww_pointer_array_add(ww_pointer_array_t *array, void *ptr);
 ...
 *
 * @return WW_SUCCESS if item was inserted. Otherwise,
 *  the error indicate what went wrong in the function.
 */
WW_DECLSPEC ww_status_t ww_pointer_array_set_item(ww_pointer_array_t *array,
...
static inline void *ww_pointer_array_get_item(ww_pointer_array_t *table,
                                                int element_index)
{
    void *p;
 ...
 */
static inline int ww_pointer_array_get_size(ww_pointer_array_t *array)
{
  return array->size;
}
 ...
 *
 * @return WW_SUCCESS new size was set. Otherwise,
 *  the error indicate what went wrong in the function.
 *
 * Simple function to set the size of the array in order to
 * hide the member field from external users.
 */
WW_DECLSPEC ww_status_t ww_pointer_array_set_size(ww_pointer_array_t *array, int size);
 ...
 */
WW_DECLSPEC bool ww_pointer_array_test_and_set_item (ww_pointer_array_t *table,
                                          int index,
                                          void *value);
 ...
 *
 */
static inline void ww_pointer_array_remove_all(ww_pointer_array_t *array)
{
    int i;
