...
#ifndef WW_HASH_TABLE_H
#define WW_HASH_TABLE_H
...
WW_DECLSPEC WW_CLASS_DECLARATION(ww_hash_table_t);

struct ww_hash_table_t
{
    ww_object_t        super;          /**< subclass of ww_object_t */
    struct ww_hash_element_t * ht_table;       /**< table of elements (opaque to users) */
    ...
    const struct ww_hash_type_methods_t * ht_type_methods;
};
typedef struct ww_hash_table_t ww_hash_table_t;
 ...
 *  @return  WW error code.
 *
 */

WW_DECLSPEC int ww_hash_table_init(ww_hash_table_t* ht, size_t table_size);

/* this could be the new init if people wanted a more general API */
WW_DECLSPEC int ww_hash_table_init2(ww_hash_table_t* ht, size_t estimated_max_size,
...
static inline size_t ww_hash_table_get_size(ww_hash_table_t *ht)
{
    return ht->ht_size;
}
 ...
 *
 *  @param   table   The input hash table (IN).
 *  @return  WW return code.
 *
 */

WW_DECLSPEC int ww_hash_table_remove_all(ww_hash_table_t *ht);
 ...
 *           - WW_SUCCESS       if key was found
 *           - WW_ERR_NOT_FOUND if key was not found
 *           - WW_ERROR         other error
 *
 */

WW_DECLSPEC int ww_hash_table_get_value_uint32(ww_hash_table_t* table, uint32_t key,
                                                   void** ptr);
...
WW_DECLSPEC int ww_hash_table_set_value_uint32(ww_hash_table_t* table, uint32_t key, void* value);
...
WW_DECLSPEC int ww_hash_table_remove_value_uint32(ww_hash_table_t* table, uint32_t key);
...
WW_DECLSPEC int ww_hash_table_get_value_uint64(ww_hash_table_t *table, uint64_t key,
                                                   void **ptr);
...
WW_DECLSPEC int ww_hash_table_set_value_uint64(ww_hash_table_t *table, uint64_t key, void* value);
...
WW_DECLSPEC int ww_hash_table_remove_value_uint64(ww_hash_table_t *table, uint64_t key);
...
WW_DECLSPEC int ww_hash_table_get_value_ptr(ww_hash_table_t *table, const void* key,
...
WW_DECLSPEC int ww_hash_table_set_value_ptr(ww_hash_table_t *table, const void* key, size_t keylen, void* value);
...
WW_DECLSPEC int ww_hash_table_remove_value_ptr(ww_hash_table_t *table, const void* key, size_t keylen);
...
WW_DECLSPEC int ww_hash_table_get_first_key_uint32(ww_hash_table_t *table, uint32_t *key,
...
WW_DECLSPEC int ww_hash_table_get_next_key_uint32(ww_hash_table_t *table, uint32_t *key,
...
WW_DECLSPEC int ww_hash_table_get_first_key_uint64(ww_hash_table_t *table, uint64_t *key,
                                       void **value, void **node);
...
WW_DECLSPEC int ww_hash_table_get_next_key_uint64(ww_hash_table_t *table, uint64_t *key,
                                       void **value, void *in_node,
                                       void **out_node);
...
WW_DECLSPEC int ww_hash_table_get_first_key_ptr(ww_hash_table_t *table, void* *key,
...
WW_DECLSPEC int ww_hash_table_get_next_key_ptr(ww_hash_table_t *table, void* *key,
 ...
 */
static inline int ww_next_poweroftwo(int value)
{
    int power2;

#if WW_C_HAVE_BUILTIN_CLZ
    if (WW_UNLIKELY (0 == value)) {
        return 1;
    }
