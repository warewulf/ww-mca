...
# ********************************************************************
#
# Internal macros - do not call from outside WW_CONFIG_POSIX_THREADS
#
# ********************************************************************


AC_DEFUN([WW_INTL_PTHREAD_TRY_LINK], [
# BEGIN: WW_INTL_PTHREAD_TRY_LINK
#
...
#
# ********************************************************************
AC_DEFUN([WW_INTL_POSIX_THREADS_PLAIN_C], [
#
# C compiler
#
if test "$ww_pthread_c_success" = "0"; then
  AC_MSG_CHECKING([if C compiler and POSIX threads work as is])

  AC_LANG_PUSH(C)
  WW_INTL_PTHREAD_TRY_LINK(ww_pthread_c_success=1,
                            ww_pthread_c_success=0)
  AC_LANG_POP(C)
  if test "$ww_pthread_c_success" = "1"; then
    AC_MSG_RESULT([yes])
  else
    AC_MSG_RESULT([no])
  fi
...
AC_DEFUN([WW_INTL_POSIX_THREADS_PLAIN_CXX], [
#
# C++ compiler
#
if test "$ww_pthread_cxx_success" = "0"; then
  AC_MSG_CHECKING([if C++ compiler and POSIX threads work as is])

  AC_LANG_PUSH(C++)
  WW_INTL_PTHREAD_TRY_LINK(ww_pthread_cxx_success=1,
                            ww_pthread_cxx_success=0)
  AC_LANG_POP(C++)
  if test "$ww_pthread_cxx_success" = "1"; then
    AC_MSG_RESULT([yes])
  else
    AC_MSG_RESULT([no])
  fi
...
AC_DEFUN([WW_INTL_POSIX_THREADS_PLAIN], [
# BEGIN: WW_INTL_POSIX_THREADS_PLAIN
#
...
# Only run C++ if that compiler already configured
AC_PROVIDE_IFELSE([AC_PROG_CC],
                  [WW_INTL_POSIX_THREADS_PLAIN_C],
                  [ww_pthread_c_success=1])

AC_PROVIDE_IFELSE([AC_PROG_CXX],
                  [WW_INTL_POSIX_THREADS_PLAIN_CXX],
                  [ww_pthread_cxx_success=1])

# End: WW_INTL_POSIX_THREADS_PLAIN
])dnl
...
#
# ********************************************************************
AC_DEFUN([WW_INTL_POSIX_THREADS_SPECIAL_FLAGS_C], [
#
# C compiler
#
if test "$ww_pthread_c_success" = "0"; then
...
AC_DEFUN([WW_INTL_POSIX_THREADS_SPECIAL_FLAGS_CXX], [
#
# C++ compiler
#
if test "$ww_pthread_cxx_success" = "0"; then
...
AC_DEFUN([WW_INTL_POSIX_THREADS_SPECIAL_FLAGS],[
# Begin: WW_INTL_POSIX_THREADS_SPECIAL_FLAGS
#
...
# Only run C++ if that compiler already configured
AC_PROVIDE_IFELSE([AC_PROG_CC],
                  [WW_INTL_POSIX_THREADS_SPECIAL_FLAGS_C],
                  [ww_pthread_c_success=1])

AC_PROVIDE_IFELSE([AC_PROG_CXX],
                  [WW_INTL_POSIX_THREADS_SPECIAL_FLAGS_CXX],
                  [ww_pthread_cxx_success=1])

# End: WW_INTL_POSIX_THREADS_SPECIAL_FLAGS
])dnl
...
#
# ********************************************************************
AC_DEFUN([WW_INTL_POSIX_THREADS_LIBS_C],[
#
# C compiler
#
if test "$ww_pthread_c_success" = "0"; then
...
AC_DEFUN([WW_INTL_POSIX_THREADS_LIBS_CXX],[
#
# C++ compiler
#
if test "$ww_pthread_cxx_success" = "0"; then
  if test ! "$ww_pthread_c_success" = "0" && test ! "$PTHREAD_LIBS" = "" ; then
...
AC_DEFUN([WW_INTL_POSIX_THREADS_LIBS],[
# Begin: WW_INTL_POSIX_THREADS_LIBS
#
...
# Only run C++ if that compiler already configured
AC_PROVIDE_IFELSE([AC_PROG_CC],
                  [WW_INTL_POSIX_THREADS_LIBS_C],
                  [ww_pthread_c_success=1])

AC_PROVIDE_IFELSE([AC_PROG_CXX],
                  [WW_INTL_POSIX_THREADS_LIBS_CXX],
                  [ww_pthread_cxx_success=1])

# End: WW_INTL_POSIX_THREADS_LIBS]
)dnl
...
#
#********************************************************************
AC_DEFUN([WW_CONFIG_POSIX_THREADS],[
...
WW_INTL_POSIX_THREADS_PLAIN

# Try the super-special compiler flags.
WW_INTL_POSIX_THREADS_SPECIAL_FLAGS

# Try the normal linking methods (that's no fun)
WW_INTL_POSIX_THREADS_LIBS
...
AC_DEFINE_UNQUOTED([WW_HAVE_PTHREAD_MUTEX_ERRORCHECK_NP], [$defval],
...
AC_LINK_IFELSE(
    ...
    [result="yes" defval=1], [result="no" defval=0])
AC_MSG_RESULT([$result])
AC_DEFINE_UNQUOTED([WW_HAVE_PTHREAD_MUTEX_ERRORCHECK], [$defval],
...
if test "$ww_pthread_c_success" = "1" && \
   test "$ww_pthread_cxx_success" = "1"; then
  internal_useless=1
  $1
else
  internal_useless=1
...
unset ww_pthread_c_success ww_pthread_cxx_success
