...
# Some distro's will attempt to force using bizarre, custom cwwler
...
#
# Print out the cwwlers
#

cat <<EOF
--> Hard-wired for cwwlers:
    CC = $CC
    CXX = $CXX
    F77 = $F77
    FC = $FC
...
specdest="$rpmtopdir/SPECS/ww-$version.spec"
